...
5. The `0.2.0-beta.3` npm prerelease is published under `next`; verify every follow-up prerelease and the matching PyPI artifact with the same clean-install, signature, and provenance checks before promotion.
